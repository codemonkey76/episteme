...
pub fn router(state: Arc<AppState>) -> Router {
    ...
    let protected = Router::new()
        ...
        .route("/api/integrations/helpdesk/config", get(integrations::helpdesk_status))
        .route("/api/integrations/helpdesk/config", post(integrations::helpdesk_connect))
        .route("/api/integrations/helpdesk/config", delete(integrations::helpdesk_disconnect))
        .route("/api/integrations/github/config", get(integrations::github_status))
        .route("/api/integrations/github/config", post(integrations::github_connect))
        .route("/api/integrations/github/config", delete(integrations::github_disconnect))
        .route("/api/integrations/phoneus/config", get(integrations::phoneus_status))
        .route("/api/integrations/phoneus/config", post(integrations::phoneus_connect))
        .route("/api/integrations/phoneus/config", delete(integrations::phoneus_disconnect))
